    ...
    public class Validate : ILib.IValidate {
        ...
        private void ValidateDcvs(string pins, bool? gate = null, TLibOutputMode? mode = null, double? voltage = null, double? voltageAlt = null,
            ...
            if (sampleRate.HasValue) {
                InRange(sampleRate.Value, dcvs.Capture.SampleRate.Min, dcvs.Capture.SampleRate.Max, "");
            }
            if (sampleSize.HasValue) {
                InRange(sampleSize.Value, dcvs.Capture.SampleSize.Min, dcvs.Capture.SampleSize.Max, "");
            }
        }
