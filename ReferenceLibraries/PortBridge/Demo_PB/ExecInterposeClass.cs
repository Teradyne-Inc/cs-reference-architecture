...
namespace Demo.PB
{
    ...
    public class ExecInterposeClass : TestCodeBase
    {
        ...
        {
            Initialize.PortBridgeInit();
            Services.Alert.Log("PB initialized successfully");

        }

        /// <summary>
        /// Immediately after the global variable reset happened.
        /// </summary>
        [ExecInterpose_OnDspAssemblyLoaded(255)]
        public static void OnDspAssemblyLoaded()
        {
            // Put code here
        ...
        /// <summary>
        /// First exec interpose to be called before the beginning of job run or validation, after assembly reloads.
        /// This exec interpose is called only once per assembly reload.
        /// </summary>
        [ExecInterpose_OnAssemblyLoaded(255)]
        ...
        {
            Services.Alert.Log("Program validated successfully!");
