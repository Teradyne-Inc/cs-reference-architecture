...
namespace CsraTestMethods.Timing {
    ...
    public class Frequency : TestCodeBase {
        ...
        /// <param name="measureWindow">Optional. Time to measure the frequency, longer measurement times yield more accurate results.</param>
