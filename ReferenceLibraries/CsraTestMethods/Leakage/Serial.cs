...
namespace CsraTestMethods.Leakage {
    ...
    public class Serial : TestCodeBase {
        ...
        /// <summary>
        /// Measures leakage currents by applying a voltage to each pin individually in a serial sequence.
        /// </summary>
        ...
        /// <param name="waitTime">The time for the force condition to settle before the measurement is made.</param>
        /// <param name="setup">Optional. The name of the setup to be applied via SetupService.</param>
        #region Baseline
        ...
        /// <summary>
        /// Runs a pattern and then measures leakage currents by applying a voltage to each pin individually in a serial sequence.
        /// </summary>
