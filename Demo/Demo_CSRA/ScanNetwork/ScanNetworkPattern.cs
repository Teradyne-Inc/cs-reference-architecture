...
namespace Demo_CSRA.ScanNetwork {
    ...
    public class ScanNetworkPattern : TestCodeBase {
        ...
        public void Baseline(Pattern scanNetworkPattern, string setupPatternCsv = "", string endPatternCsv = "",
            string setup = "", bool runDiagnosis = false, bool multiCoreDiagnosis = false) {
            ...
            if (ShouldRunBody) {
                ...
                if (runDiagnosis) {
                    ...
                    TheLib.Execute.ScanNetwork.RunDiagnosis(_scanNetworkPattern, _nonDiagnosisResults, multiCoreDiagnosis);
                }
            }
