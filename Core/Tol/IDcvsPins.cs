...
namespace Tol {
    ...
    public interface IDcvsPins : IPins<IDcvsPins> {
        ...
        /// <param name="forceVoltageRange">The voltage range for forcing. On DCVS this single range also governs the voltage meter.</param>
        /// <param name="gate">Optional. The gate state after setting.</param>
        public void ForceVSetMeterV(double forceVoltage, double clampCurrent, double forceVoltageRange, bool? gate = null);
        ...
        /// <param name="voltageRange">Optional. The voltage (force) range. DCVS has no independent meter voltage range, so this sets the force range used to validate the forced voltage. When null, the previously programmed range is retained.</param>
        /// <param name="gate">Optional. The gate state after setting.</param>
        public void ForceVSetMeterI(double forceVoltage, double clampCurrent, double measureCurrentRange, double? voltageRange = null, bool? gate = null);
