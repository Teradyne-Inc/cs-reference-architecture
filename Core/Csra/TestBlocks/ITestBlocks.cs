...
namespace Csra.Interfaces {
    ...
    public interface ILib {
        ...
        public interface IValidate {
            ...
            /// <param name="sampleRate">Optional. Sample rate parameter to be validated.</param>
            /// <param name="sampleSize">Optional. Sample size parameter to be validated.</param>
        ...
        public interface ISetup {
            ...
            public interface IDc {
                ...
                /// </summary>
                /// <param name="capturePin">Pin to be captured.</param>
                /// <param name="signalName">Name of the signal.</param>
                /// <param name="meterMode">Meter mode to set for capture signal.</param>
                /// <param name="range">Range to set for the signal.</param>
                /// <param name="sampleRate">Sample rate to capture for the signal.</param>
                /// <param name="sampleSize">Sample size to capture for the signal.</param>
                /// <param name="loadSettings">Optional. Load settings after configuring the capture signal. True by default.</param>
                ...
                /// <param name="forceRange">Voltage or current to set the force range. For DCVS in ForceVoltage mode this is also the range used to validate the
                /// forced voltage, because DCVS has no independent meter voltage range. Set it to cover forceValue to avoid DCVS:0003.</param>
                ...
                /// <param name="meterMode">Set the meter mode to voltage or current.</param>
                /// <param name="measureRange">Set the meter's range to the expected current or voltage. For PPMU: used as the measure current range.
                /// For DCVI: used as the meter range, independent from the force range. For DCVS in MeterVoltage mode: not used as the voltage range
                /// (force and meter share the same range, so forceRange is applied instead).</param>
                /// <param name="gateOn">Optional. Default gate on the pins after after the settings,False no gate change.</param>
            ...
            public interface IDigital {
                ...
                /// </summary>
                /// <param name="rampPin">Digital pin to configure ramp on.</param>
                /// <param name="signalName">Signal name of ramp.</param>
                /// <param name="startingValue">Starting value for ramp.</param>
                /// <param name="incrementValue">Increment value for ramp.</param>
                /// <param name="incrementPeriod">Increment period for ramp.</param>
                /// <param name="startDelay">Delay to begin incrementing from start of ramp.</param>
                /// <param name="incrementCount">Increment count for ramp.</param>
                ...
                /// </summary>
                /// <param name="capturePins">Pin to configure PPMU to capture data.</param>
                /// <param name="numSamplesPerStrobe">The number of samples to read per strobe.</param>
                /// <param name="readFormat">The reading format for the Pattern Control.</param>
        ...
        public interface IExecute {
            ...
            public interface IDigital {
                ...
                /// </summary>
                /// <param name="rampPin">Digital pin that ramp was configured on.</param>
                /// <param name="patternInfo">Pattern to be executed.</param>
                /// <param name="signalName">Signal for ramp.</param>
                /// <param name="timeout">Period of time to wait for PPMU to finish sourcing.</param>
                public void RunPatternSyncRamp(Pins rampPin, PatternInfo patternInfo, string signalName, double timeout);
            }
        ...
        public interface IAcquire {
            ...
            public interface IDigital {
                ...
                /// <summary>
                /// Tries to read failing cycle data from the configured capture memory.
                /// </summary>
                /// <param name="digitalCapture">Tol digital capture object configured for fail capture.</param>
                /// <param name="fails">When successful, contains the failing cycle indices per pin and site; otherwise <see langword="null"/>.</param>
                /// <returns><see langword="true"/>If the data was successfully read; otherwise, <see langword="false"/>.</returns>
                public bool TryReadFailsCapture(Tol.IDigitalCapture digitalCapture, out Teradyne.Igxl.Interfaces.Public.PinSite<int[]> fails);

                /// <summary>
                /// Tries to read STV device data from the configured capture memory.
                /// </summary>
                /// <param name="digitalCapture">Tol digital capture object configured for STV capture.</param>
                /// <param name="stv">When successful, contains the captured device data values per pin and site; otherwise <see langword="null"/>.</param>
                /// <returns><see langword="true"/>If the data was successfully read; otherwise, <see langword="false"/>.</returns>
                public bool TryReadStvCapture(Tol.IDigitalCapture digitalCapture, out Teradyne.Igxl.Interfaces.Public.PinSite<double[]> stv);
            }
        ...
        public interface IDatalog {
            ...
            public void TestFunctional(Site<bool> result, string pattern = "", string tName = "");
            ...
            /// <param name="tName">Optional. The test name to use for datalogging.</param>
            public void TestParametric(Site<int> result, double loVal, double hiVal, string tName = "");
            ...
            /// <param name="hiVal">The high limit value.</param>
            /// <param name="tName">Optional. The test name to use for datalogging.</param>
            public void TestParametric(PinSite<double> result, double loVal, double hiVal, string tName = "");
