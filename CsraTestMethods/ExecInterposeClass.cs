    ...
    public class ExecInterposeClass : TestCodeBase {
        ...
        public static void OnValidationStart() {
            ...
            try {
                ...
                /* in case the user want warning option and not Error which cause the validation fail, we can use Warning instead of Error */
                    //Services.Alert.Warning($"IG-Component Manager file is invalid:  {e.Message}");
            }                       
        }
