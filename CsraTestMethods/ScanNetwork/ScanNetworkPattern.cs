...
namespace CsraTestMethods.ScanNetwork {
    ...
    public class ScanNetworkPattern : TestCodeBase {
        ...
        public void Baseline(Pattern scanNetworkPattern, string setupPatternCsv = "", string endPatternCsv = "",
            ...
            if (ShouldRunBody) {
                ...
                if (runDiagnosis) {
                    ...
                    TheLib.Datalog.TestScanNetwork(_nonDiagnosisResults,
                        ScanNetworkDatalogOption.ByCoreInstance | ScanNetworkDatalogOption.FailedInstancesOnly);
            ...
            if (ShouldRunPostBody) {
                ...
                if (!runDiagnosis)
                    TheLib.Datalog.TestScanNetwork(_nonDiagnosisResults,
                        ScanNetworkDatalogOption.ByCoreInstance | ScanNetworkDatalogOption.PatGenWithFtr);

                // sample datalog of the ScanNetworkPatternResults object. Two flavors demonstrated, this one logs the result by icl-instance.
                TheLib.Datalog.TestScanNetwork(_nonDiagnosisResults,
                    ScanNetworkDatalogOption.ByIclInstance | ScanNetworkDatalogOption.VerboseInfoByDtr);
            }
        }
        #endregion
    }
