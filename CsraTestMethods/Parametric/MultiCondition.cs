...
namespace CsraTestMethods.Parametric {
    ...
    public class MultiCondition : TestCodeBase {
        ...
        private DcMeterMode[] _measureModes;
        private DcOutputMode[] _outputModes;
        ...
        /// <param name="measureModes">Comma separated list of the measurement modes for each pin or pin group.</param>
        /// <param name="measureRanges">Comma separated list of the measurement ranges for each pin or pin group.</param>
