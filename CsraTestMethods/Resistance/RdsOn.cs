...
namespace CsraTestMethods.Resistance {
    ...
    public class RdsOn : TestCodeBase {
        ...
        private DcOutputMode _outputMode;
        private DcMeterMode _measureMode;
        ...
        /// <param name="measureRangeFirstPin">Measurement range of first measured pin.</param>
        /// <param name="measureSecondPin">Second pin to measure voltage.</param>
        /// <param name="measureRangeSecondPin">Measurement range of second measured pin.</param>
        /// <param name="waitTime">Optional. Wait time after forcing.</param>
        ...
        /// <param name="measureFirstPin">First pin to measure voltage.</param>
        /// <param name="measureSecondPin">Second pin to measure voltage.</param>
        /// <param name="measureRangeFirstPin">Measurement range of first measured pins.</param>
        /// <param name="measureRangeSecondPin">Measurement range of second measured pins.</param>
        /// <param name="waitTime">Optional. Wait time after forcing.</param>
        /// <param name="setup">Optional. Name of the setup set to be applied through the setup service.</param>
